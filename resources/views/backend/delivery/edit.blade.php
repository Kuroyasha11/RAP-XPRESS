...
@section('container')
    ...
    <div class="col-lg-5">
        <div class="mt-3 mb-3">
            <a href="/dashboard/pengiriman/{{ $request->slug }}" class="btn btn-success"><i
                    class="bi bi-arrow-left-circle"></i> Back</a>
        </div>
    </div>

    <div class="col-lg-15">
        <form action="/dashboard/pengiriman/{{ $request->slug }}" method="post">
            @method('put')
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" id="nama"
                    placeholder="Nama" value="{{ old('nama', $request->nama) }}" autofocus required>
                @error('nama')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                <label for="shipping_id" class="form-label">Kelas Pengiriman</label>
