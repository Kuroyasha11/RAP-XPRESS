...
@section('container')
    ...
    @endif
    <h2>Kurir Pengambilan Paket RAP-XPRESS yang Tersedia</h2>
    <div class="row justify-content-start mb-3">
        <div class="col-lg-3">
            <form action="/dashboard/pickup" method="get">
    ...
    <div class="table-responsive col-lg-15 mb-5">
        <div class="d-flex justify-content-between">
            <a href="/dashboard/pickup/create" class="btn btn-success"><i class="bi bi-plus-circle"></i> Request</a>
            {{ $pickup->links() }}
        </div>
                ...
                @if ($pickup->count())
                    @foreach ($pickup as $pick)
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/dashboard/pickup/{{ $pick->id }}" class="btn btn-danger">
