...
@section('container')
    ...
    <div class="col-lg-5">
        <div class="mt-3 mb-3">
            <a href="/dashboard/permintaan" class="btn btn-success"><i class="bi bi-arrow-left-circle"></i>
                Back</a>
        </div>
    </div>
        ...
        <form action="/dashboard/permintaan" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('namapemohon') is-invalid @enderror" name="namapemohon"
                    id="namapemohon" placeholder="Nama Pemohon" value="{{ old('namapemohon') }}" autofocus required>
                @error('namapemohon')
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control @error('telepon') is-invalid @enderror" name="telepon" id="telepon"
                    placeholder="Nomor Pemohon" value="{{ old('telepon') }}" required>
                @error('telepon')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('namapenerima') is-invalid @enderror" name="namapenerima"
                    id="namapenerima" placeholder="Nama Penerima" value="{{ old('namapenerima') }}" required>
                @error('namapenerima')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
    ...
    <script>
        ...
        nama.addEventListener('change', function() {
            fetch('/dashboard/permintaan/checkSlug?nama=' + nama.value)
